...
public class BestTimeToBuyAndSellStockTest {
    ...
    private BestTimeToBuyAndSellStock app;

    @Before
    public void initialize() {
        app = new BestTimeToBuyAndSellStock();
    }

    public BestTimeToBuyAndSellStockTest(int[] prices, int expectedResult) {
        this.prices = prices;
    ...
    {
        assertEquals(expectedResult, app.maxProfitOptimal(prices));
    }
}
